  ...
  <div v-if="store.settings" class="space-y-4">
    ...
    <div class="card">
      ...
      <p class="mb-3 text-sm text-gray-500">
        Provide your own LaTeX source with a <code v-pre>{{CONTENT}}</code> placeholder where the generated content
      ...
      <div class="grid gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <template v-else-if="cvMode === 'upload'">
            ...
            <div>
              <button class="btn-primary mt-2" :disabled="!latexCv" @click="saveLatexCv">Save CV template</button>
            </div>
          </template>
        </div>
        <!-- Cover template -->
        <div>
          ...
          <template v-else-if="coverMode === 'upload'">
            ...
            <div>
              <button class="btn-primary mt-2" :disabled="!latexCover" @click="saveLatexCover">Save cover template</button>
            </div>
          </template>
        </div>
      </div>
